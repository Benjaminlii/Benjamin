...
<head>
    ...
    %>
    <script type="text/javascript" src="${APP_PATH}/views/js/jquery-3.3.1.js"></script>
    <link href="${APP_PATH}/views/static/bootstrap-3.3.7-dist/css/bootstrap.min.css" rel="stylesheet">
    <script src="${APP_PATH}/views/static/bootstrap-3.3.7-dist/js/bootstrap.min.js"></script>
</head>
<body>
...
<script type="text/javascript">
    ...
    function to_page(pn) {
        $.ajax({
            url:"/ssm-crud/getEmployeesByPage",
            data:"page="+pn,
            type:"GET",
    ...
    $("#emp_update_btn").click(function () {
        ...
        //2、发送ajax请求，保存更新员工信息
        $.ajax({
            url:"/ssm-crud/updateEmployee",
            type:"post",
            data:$("#empUpdateModal form").serialize()+"&empId="+$(this).attr("edit_id"),
            success:function () {
                // alert(result.message);
