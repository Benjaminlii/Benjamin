                                    ...
                                    <label>
                                        <form id="alipayForm"
                                            ...
                                            <div class="img_cnt" id="alipay">
                                                ...
                                                <input type="hidden" id="alipayMoney" name="rechargeMoney" value=""/>
                                            </div>
                                        </form>
                                    </label>
                                    <label>
                                        <form id="wxpayForm"
                                              action="${pageContext.request.contextPath}/loan/toWxpayRecharge"
                                              method="post" target="_blank">
                                            <div class="img_cnt" id="weixinpay">
                                                <img src="${pageContext.request.contextPath}/images/weixinpay.jpg"/>
                                                <input type="hidden" id="wxpayMoney" name="rechargeMoney" value=""/>
                                            </div>
                                        </form>
                                    </label>
                                </div>
