...
public class Constant {
     ...
     * 验证码短信的模板
     */
    public static final String VERCODE_SSM = "【TC科技小组】alarm-您的验证码是%s，手机号码为%s的账号申请你成为紧急联系人.";
    ...
    /**
     * 全局保存当前用户调用接口发送的短信验证码
     */
    public static final String UID_VERCODE_CALL_PHONE = "vercode";
